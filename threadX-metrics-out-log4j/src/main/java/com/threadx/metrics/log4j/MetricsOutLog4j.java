...
public class MetricsOutLog4j implements MetricsOutApi {
    ...
    @Override
    public void outMetricsData(String metricsData) {
        Logger logger = loggerSlf4jLog4j2.getLogger(MetricsOutLog4j.class);
        logger.info(metricsData);
    }

    @Override
    public void outMetricsData(List<String> metricsDataList) {
        for (String metricsData : metricsDataList) {
            outMetricsData(metricsData);
        }
    }
