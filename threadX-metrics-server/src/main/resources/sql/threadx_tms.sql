...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '实例名称' ROW_FORMAT = Dynamic;
...
CREATE TABLE `server_item`  (
  ...
  `create_time` bigint(64) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '记录当前监控的服务' ROW_FORMAT = Dynamic;
...
CREATE TABLE `thread_pool_data`  (
  ...
  `create_time` bigint(64) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '线程池的监控数据' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `thread_task_data`  (
  ...
  `thread_pool_group_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线程池组的名称',
  `thread_pool_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线程池的名称',
  `thread_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '被那一个线程执行的',
  ...
  `instance_id` bigint(32) NOT NULL COMMENT '所属实例的id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '线程池内任务执行信息' ROW_FORMAT = DYNAMIC;
