...
CREATE TABLE `instance_list` (
                                 ...
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='实例名称';
...
CREATE TABLE `server_list` (
                               ...
                               `server_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '服务名称',
                               `create_time` bigint(64) NOT NULL COMMENT '创建时间',
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='记录当前监控的服务';
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='线程池的监控数据';
...
CREATE TABLE `thread_task_data` (
                                    ...
                                    `thread_pool_group_name` varchar(255) NOT NULL COMMENT '线程池组的名称',
                                    `thread_pool_name` varchar(255) NOT NULL COMMENT '线程池的名称',
                                    `thread_name` varchar(255) NOT NULL COMMENT '被那一个线程执行的',
                                    ...
                                    `instance_id` bigint(32) NOT NULL COMMENT '所属实例的id',
                                    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='线程池内任务执行信息';
